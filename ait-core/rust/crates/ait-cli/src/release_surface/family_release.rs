...
fn family_promotion_routes(
    ...
    json!({
        ...
        "npm": {
            "version": version,
            "dist_tag": if prerelease { "rc" } else { "latest" },
        },
        "pypi": {
            "repository": "pypi",
            "prerelease": prerelease,
        ...
        "oci": {
            "version_tag": version,
            "moving_tag": if prerelease { "rc" } else { "latest" },
        },
        "homebrew": {
            "channel": if prerelease { "rc" } else { "stable" },
            "stable_formula_mutation": !prerelease,
        },
        "apt": {
            "suite": if prerelease { "testing" } else { "stable" },
        },
        "winget": {
            "route": if prerelease { "validation" } else { "community" },
            "community_manifest_submission": !prerelease,
        },
    })
}
...
mod tests {
    ...
    #[test]
    fn rc_promotion_routes_never_select_stable_channels() {
