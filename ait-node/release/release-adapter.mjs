...
const PACKAGE_VERSION = "1.0.0-rc.9";
    ...
    payloadContract.payloads.every(
      (payload) => {
        ...
        return (
          ...
          payload.binding_snapshot === "SNP-22EC9E9A6AB0" &&
...
async function main() {
  ...
  if (process.argv.length !== 5) {
    throw new Error(
      "usage: node release/release-adapter.mjs {check|build|smoke} <target|portable> 1.0.0-rc.9",
    );
  }
