...
const PACKAGE_VERSION = "1.0.0-rc.13";
    ...
    payloadContract.payloads.every(
      (payload) => {
        ...
        return (
          ...
          payload.binding_snapshot === "SNP-AB80C507E78F" &&
...
async function main() {
  ...
  if (process.argv.length !== 5) {
    throw new Error(
      "usage: node release/release-adapter.mjs {check|build|smoke} <target|portable> 1.0.0-rc.13",
    );
  }
