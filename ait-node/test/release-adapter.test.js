...
test("release adapter declares the portable envelope and six native addons", async () => {
  ...
  assert.deepEqual(component.artifacts[0], {
    path: "dist/wa120-ait-native-1.0.0-rc.11.tgz",
  ...
  assert.deepEqual(
    ...
    [
      "dist/wa120-ait-native-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-darwin-arm64-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-darwin-x64-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-linux-arm64-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-linux-x64-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-win32-arm64-1.0.0-rc.11.tgz",
      "dist/npm-addons/wa120-ait-native-win32-x64-1.0.0-rc.11.tgz",
    ],
  );
  assert.deepEqual(
...
test("release tools are registry-inert and package direct addon fixtures", async () => {
  ...
  assert.match(ci, /release-adapter\.mjs build portable 1\.0\.0-rc\.11/);
  assert.match(ci, /release-adapter\.mjs smoke portable 1\.0\.0-rc\.11/);
});
