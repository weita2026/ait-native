...
def create_app() -> FastAPI:
    ...
    app = FastAPI(title="ait native server", version="0.10.6")
    ...
    register_session_routes(
        ...
        bad_request=_bad_request,
        conflict=_conflict,
        clear_admin_response_cache=_clear_admin_response_cache,
        start_live_turn=start_live_turn,
        finish_live_turn=finish_live_turn,
    )
