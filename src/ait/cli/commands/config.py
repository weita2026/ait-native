...
from ...store_repo_config import update_config
...
def _apply_config_set_updates(
    ctx,
    cfg,
    *,
    default_author_mode,
    clear_default_author_mode,
    default_model,
    clear_default_model,
    task_tracking,
    command_profiling,
    task_dag_allow_multi_worker,
    task_worktree_alias_root,
    clear_task_worktree_alias_root,
    task_worktree_main_seed_ram_max_bytes,
    clear_task_worktree_main_seed_ram_max_bytes,
    legacy_task_auto_worktree,
    workflow_mode,
    workflow_default_scope,
    clear_workflow_default_scope,
    task_default_scope,
    clear_task_default_scope,
    change_default_scope,
    clear_change_default_scope,
    id_namespace_prefix,
    clear_id_namespace_prefix,
    plan_task_binding_mode,
    clear_plan_task_binding,
    user_name,
    clear_user_name,
    user_email,
    clear_user_email,
    ...
    if clear_task_worktree_main_seed_ram_max_bytes:
        task_worktree_cfg.pop("main_seed_ram_max_bytes", None)
    elif task_worktree_main_seed_ram_max_bytes is not None:
        normalized_main_seed_ram_max_bytes = normalize_task_worktree_main_seed_ram_max_bytes(
            task_worktree_main_seed_ram_max_bytes
        )
        if normalized_main_seed_ram_max_bytes is None:
            raise typer.BadParameter("`--task-worktree-main-seed-ram-max-bytes` must be a non-negative integer.")
        task_worktree_cfg["main_seed_ram_max_bytes"] = normalized_main_seed_ram_max_bytes

    derived_ephemeral_root = derived_task_worktree_ephemeral_root(ctx, task_worktree_cfg.get("memory_root"))
    if derived_ephemeral_root is not None and task_worktree_cfg.get("ephemeral_root") == derived_ephemeral_root:
...
def config_set(
    ...
    task_worktree_main_seed_ram_max_bytes: Optional[int] = typer.Option(
        None,
    ...
    clear_task_worktree_main_seed_ram_max_bytes: bool = typer.Option(
        False,
    ...
    if (
        task_worktree_main_seed_ram_max_bytes is not None
        and clear_task_worktree_main_seed_ram_max_bytes
    ):
        raise typer.BadParameter(
            "Choose either --task-worktree-main-seed-ram-max-bytes or --clear-task-worktree-main-seed-ram-max-bytes"
        )
    ...
    if (
        ...
        and task_worktree_main_seed_ram_max_bytes is None
        ...
        and not clear_task_worktree_main_seed_ram_max_bytes
    ...
    update_config(
        ctx,
        lambda cfg: _apply_config_set_updates(
            ctx,
            cfg,
            default_author_mode=default_author_mode,
            clear_default_author_mode=clear_default_author_mode,
            default_model=default_model,
            clear_default_model=clear_default_model,
            task_tracking=task_tracking,
            command_profiling=command_profiling,
            task_dag_allow_multi_worker=task_dag_allow_multi_worker,
            task_worktree_alias_root=task_worktree_alias_root,
            clear_task_worktree_alias_root=clear_task_worktree_alias_root,
            task_worktree_main_seed_ram_max_bytes=task_worktree_main_seed_ram_max_bytes,
            clear_task_worktree_main_seed_ram_max_bytes=clear_task_worktree_main_seed_ram_max_bytes,
            legacy_task_auto_worktree=legacy_task_auto_worktree,
            workflow_mode=workflow_mode,
            workflow_default_scope=workflow_default_scope,
            clear_workflow_default_scope=clear_workflow_default_scope,
            task_default_scope=task_default_scope,
            clear_task_default_scope=clear_task_default_scope,
            change_default_scope=change_default_scope,
            clear_change_default_scope=clear_change_default_scope,
            id_namespace_prefix=id_namespace_prefix,
            clear_id_namespace_prefix=clear_id_namespace_prefix,
            plan_task_binding_mode=plan_task_binding_mode,
            clear_plan_task_binding=clear_plan_task_binding,
            user_name=user_name,
            clear_user_name=clear_user_name,
