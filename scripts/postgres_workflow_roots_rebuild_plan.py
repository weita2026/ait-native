...
ROOT_TABLE_SPECS = [
    ...
    },
    {
        ...
        "columns": ["task_id", "repo_name", "repo_id", "task_seq", "title", "intent", "risk_tier", "planning_state", "plan_id", "origin_plan_revision_id", "plan_item_ref", "plan_section_ref", "plan_drift_state", "plan_linked_at", "historical_publication_id", "status", "created_at"],
        "repo_name_unique": False,
    ...
    },
    {
        ...
        "columns": ["change_id", "repo_name", "repo_id", "change_seq", "task_id", "title", "base_line", "fork_snapshot_id", "forked_from_line", "risk_tier", "lane", "historical_publication_id", "status", "current_patchset_number", "selected_patchset_number", "created_at", "updated_at", "landed_at"],
        "repo_name_unique": False,
